...
from graph.router import (route_news,route_stocks)
...
graph.add_edge("memory","stocks")
graph.add_node("news",news_agent)
graph.add_node("stocks",stock_agent)
graph.add_node("analyst",analyst)
graph.add_node("critic",critic)
graph.set_entry_point("planner")
graph.add_conditional_edges("memory",route_news)
graph.add_conditional_edges("memory",route_stocks)
graph.add_edge("news","analyst")
graph.add_edge("stocks","analyst")
